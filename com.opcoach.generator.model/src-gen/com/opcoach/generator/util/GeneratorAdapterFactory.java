...
public class GeneratorAdapterFactory extends AdapterFactoryImpl
{
	...
	protected GeneratorSwitch<Adapter> modelSwitch =
		new GeneratorSwitch<Adapter>() {
			...
			@Override
			public Adapter caseGeneratorParameter(GeneratorParameter object) {
				return createGeneratorParameterAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.opcoach.generator.MGeneratorParameter <em>Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGeneratorParameterAdapter() {
		return null;
	}
