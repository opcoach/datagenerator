...
/**
 * This is the item provider adapter for a {@link com.opcoach.generator.MRangeGenerator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	extends ValueGeneratorItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MGeneratorPackage.Literals.RANGE_GENERATOR__LOW,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MGeneratorPackage.Literals.RANGE_GENERATOR__HIGH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MGeneratorPackage.Literals.RANGE_GENERATOR__STEP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	{
		String label = ((MRangeGenerator<?>)object).getID();
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(MRangeGenerator.class)) {
