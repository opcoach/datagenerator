...
/**
 * This is the item provider adapter for a {@link com.opcoach.generator.MReferenceGenerator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceGeneratorItemProvider
	extends ValueGeneratorItemProvider
{
	 ...
	 * @generated
	 */
	public ReferenceGeneratorItemProvider(AdapterFactory adapterFactory)
	{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferenceGenerator_step_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferenceGenerator_step_feature", "_UI_ReferenceGenerator_type"),
				 MGeneratorPackage.Literals.REFERENCE_GENERATOR__STEP,
				 true,
				 false,
				 false,
	...
	{
		String label = ((MReferenceGenerator<?>)object).getID();
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(MReferenceGenerator.class)) {
